      <br><br>
      <h3 class="header center">VERIFIKASI BERKAS TA</h3>

      <div class="row center">
        <h6 class="header col s12 light">Form ini digunakan untuk memverifikasi berkas revisi TA sebagai syarat untuk Yudisium & Wisuda mahasiswa</h6>
      </div>
      <br><br>
